...
export function TreatmentHero() {
  const TreatmentHero = treatments.filter((t) => t.featured).slice(0, 4);
    ...
    <section className="py-24 md:py-32 overflow-hidden">
      <div className="container-page">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 xl:grid-cols-4">
          {TreatmentHero.map((treatment, index) => (
        ...
        <Reveal delay={0.35}>
          <div className="mt-20 rounded-[32px] border border-border bg-card p-10 text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Link
                to="/book-appointment"
                className="rounded-full bg-primary px-8 py-4 font-medium text-primary-foreground transition hover:scale-105"
              >
                {clinic.cta.primary}
              </Link>
              ...
              <a
                ...
                className="rounded-full border border-border px-8 py-4 font-medium transition hover:border-primary hover:text-primary"
              >
